...
public class TahsilatDetay implements Serializable {
    ...
    @NotNull
    @SequenceGenerator(name = "tahsilatdetayseq",initialValue = 1,allocationSize = 1,sequenceName = "SEQ_THS_TAHSILAT_DETAY")
    ...
    public Tahsilat getTahsilatNo() {
        return tahsilatNo;
    }

    public void setTahsilatNo(Tahsilat tahsilatNo) {
        this.tahsilatNo = tahsilatNo;
    }
    ...
    public String toString() {
        return "tr.gov.ptt.entity.TahsilatDetay[ no=" + no + " ]";
    }
